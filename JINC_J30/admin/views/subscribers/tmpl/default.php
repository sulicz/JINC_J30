...
<form action="index.php" method="post" name="adminForm">
    <fieldset id="filter-bar">
        ...
        <div class="filter-select fltrt">
            <select name="filter_sub_state" class="inputbox" onchange="this.form.submit()">
                <option value=""><?php echo JText::_('COM_JINC_SELECT_SUB_STATE'); ?></option>
                <?php echo JHtml::_('select.options', JFormFieldJINCSubState::getOptions(), 'value', 'text', $this->state->get('filter.sub_state')); ?>
            </select>
