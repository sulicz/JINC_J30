...
class JINCViewMessage extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        if ($layout == 'send') {
            ...
            JToolBarHelper::title(JText::_('COM_JINC_MESSAGE') . ': <small><small>[ ' . JText::_('COM_JINC_JTOOLBAR_PREVIEW') . ' ]</small></small>', 'jinc');
            jincimport('utility.jinchelper');
            JToolBarHelper::back();            
            JINCHelper::helpOnLine(96);
        } else {
