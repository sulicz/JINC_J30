...
require_once 'unsubscriptionnotifyevent.php';
...
$dispatcher->register('jinc_unsubscribe', 'UnsubscriptionNotifyEvent');
...
define('SUSPEND_NO', 0);
define('SUSPEND_SUBSCRIPTION', 1);
define('SUSPEND_UNSUBSCRIPTION', 2);
define('SUSPEND_BOTH', 3);
...
class Newsletter extends JINCObject {
    ...
    /**
     * True is subscription to this newsletter is suspended from frontend.
     *
     * @var	Suspended Subscription
     * @access	protected
     * @since	1.0
     */
    var $suspended;
