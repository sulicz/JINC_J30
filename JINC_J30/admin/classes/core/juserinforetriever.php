...
class JUserInfoRetriever extends SubsRetriever {
    ...
    function getSubscribersList($start_time = 0, $start_id = 0, $multiplexer = 1, $attributes = null) {
        ...
        $query = 'SELECT s.id as id, u.email as email, u.username as username, u.name as name, u.id as user_id, ' .
    ...
    function getSubscriber($id = 0, $attributes = null) {
        ...
        $query = 'SELECT u.email as email, u.id as user_id, u.username as username, u.name as name, datasub, INET_NTOA(s.ipaddr) as ipaddr ';
