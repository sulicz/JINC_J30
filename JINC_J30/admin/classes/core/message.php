...
class Message extends JINCObject {
    ...
    /**
     * The template the message is associated to
     *
     * @var	The template the message is associated to
     * @access	protected
     * @since	1.0
     */
    var $_template = null;
    ...
    /**
     *
     * @var             Last mail system error message
     * @access          protected
     * @since           1.0
     */
    var $mail_system_error = '';

    /**
     *
     * @var             Failed recipients
     * @access          protected
     * @since           1.0
     */
    var $reported_recipients;

    /**
     * The template identifier associated to the message
     *
     * @var	The template identifier associated to the message
     * @access	protected
     * @since	1.0
     */
    var $tem_id = 0;
