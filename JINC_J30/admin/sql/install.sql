...
-- Added from JINC 1.0 for subscription suspending
...
-- Changed from JINC 0.8
  `attachment` TEXT,
-- Change from JINC 1.0
  `tem_id` int NOT NULL default 0,
  PRIMARY KEY  (`id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__jinc_template` (
  ...
  `subject` varchar(128) NOT NULL,
  `body` mediumtext NOT NULL,
  `cssfile` varchar(1024) NOT NULL default '',
  PRIMARY KEY  (`id`)
) DEFAULT CHARSET=utf8;
